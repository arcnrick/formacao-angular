...
export class CalculadoraComponent implements OnInit {
  ...
  /**
   * Inicializa todos os operadores para os valores default
   * 
   * @return void
   */
  limpar(): void {
  ...
  concatenarNumero(numAtual: string, numConcat: string): string {
    // caso numAtual contenha apenas '0' ou null, reinicia o valor
    ...
    // caso '.' digitado e já contenha um '.', apenas retorna o que já existe
   ...
   * @return void 
   */
  definirOperacao(ope: string): void {
    ...
    /* caso a operação definida e  numero2 informado, efetua o cálculo da operação */
